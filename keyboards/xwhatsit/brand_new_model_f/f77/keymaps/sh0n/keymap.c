...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_ansi_regular_shift_regular_backspace(
        ...
        KC_CAPS,      KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT,            KC_MEDIA_PLAY_PAUSE, KC_MEDIA_PREV_TRACK, KC_MEDIA_NEXT_TRACK,
        KC_LSFT,         KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,            KC_ESC,       KC_UP,     KC_ENT,
        KC_LCTRL, KC_LGUI, KC_LALT,                      KC_SPC,                  KC_RALT, MO(_FN), KC_RCTRL,    KC_LEFT,     KC_DOWN,   KC_RIGHT
    ),
    [_FN] = LAYOUT_ansi_regular_shift_regular_backspace(
        KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8,   KC_F9, KC_F10,    KC_F11, KC_F12, KC_INS,                KC_P7,         KC_P8,         KC_P9,
        ...
        _______,         KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PPLS, KC_PMNS, KC_END, KC_PGDN, KC_DOWN, _______,                   KC_P0,      KC_AUDIO_VOL_UP,  KC_NO,
        _______, _______, _______,                             MO(_FN2),                       _______, _______, KC_NLCK,      KC_AUDIO_MUTE, KC_AUDIO_VOL_DOWN, KC_NO
    ),
